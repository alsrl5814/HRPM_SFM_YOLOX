...
class VOCDetection(Dataset):
    ...
    def evaluate_detections(self, all_boxes, output_dir=None):
        ...
        Precisions = []
        for iou in IouTh:
            mAP, recall, precision = self._do_python_eval(output_dir, iou) #
            mAPs.append(mAP)
        ...
        print("--------------------------------------------------------------")
        print("--------------------------------------------------------------")
        print("recall_5095:", np.mean(Recalls))
        print("recall_50:", Recalls[0])
        print("--------------------------------------------------------------")
        print("--------------------------------------------------------------")
        print("precision_5095:", np.mean(Precisions))
        print("precision_50:", Precisions[0])
        print("--------------------------------------------------------------")
    ...
    def _do_python_eval(self, output_dir="output", iou=0.5):
        ...
        for i, cls in enumerate(VOC_CLASSES):
            ...
            #print(rec, prec, ap)
            #print(len(recs), len(precs), len(aps))
            #print(recs)
            #print(np.sum(recs) / len(recs))
        ...
        if iou == 0.5:
            ...
            print("--------------------------------------------------------------")
            #print(np.mean(recs), np.mean(precs), np.mean(aps))
